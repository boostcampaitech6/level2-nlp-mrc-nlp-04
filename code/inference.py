...
def run_sparse_retrieval(
    ...
    retriever = DensePassageRetriever(
        document_sotre = data_path,
        query_embedding_model = 'KevinChoi/dpr-question_encoder-klue-roberta-base',
        passage_embedding_models = 'KevinChoi/dpr-context_encoder-klue-roberta-base',
        use_gpu = True,
        embed_title = True
    )
    '''
    retriever.get_sparse_embedding() # SparseRetrieval
